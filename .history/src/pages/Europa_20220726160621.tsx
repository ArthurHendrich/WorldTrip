...
export default function Europa() {
  return (
    <>
      ...
      >
        <Box as ="div" flex="1">
          <Text color="gray.600" lineHeight="2.5rem">
          A Europa é, por convenção, um dos seis continentes do mundo. Compreendendo a península ocidental da Eurásia, a Europa geralmente divide-se da Ásia a leste pela divisória de águas dos montes Urais, o rio Ural, o mar Cáspio, o Cáucaso, e o mar Negro a sudeste
          </Text>
        </Box>
        <Box as="div" display="flex" alignItems="center" justifyContent="flex">
          <Box display="flex" alignItems="center" justifyContent="center" flexDirection="column"><Text color="yellow.600">50</Text><Text>paises</Text></Box>
