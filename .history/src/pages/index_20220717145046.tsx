  ...
  return (
    <>
      ...
      <Box as="section" maxWidth={1280} margin="auto" marginBottom="3.25rem">
        ...
        >
          <SwiperSlide>
            <Text position="absolute" color="white" fontSize="3rem">Europa Teste</Text>
            <Text position="absolute" color="white" fontSize="1.5rem" top="1px" >Brincadeira</Text>

            <Image src="images/Europe.png" alt="slide1" />
          </SwiperSlide>
          <SwiperSlide>
            <Image src="images/Na.jpg" alt="slide1" />
          </SwiperSlide>
          <SwiperSlide>
