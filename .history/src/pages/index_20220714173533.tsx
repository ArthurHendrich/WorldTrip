...
export default function Home() {
  return (
    <>
      ...
      <Box bg='red.100' display='flex' alignItems='center' justifyContent='center' height='30rem'>
        <Swiper spaceBetween={30} pagination={{clickable: true,}} modules={[Pagination]} className={styles.mySwiper}>
